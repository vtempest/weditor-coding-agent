...
function requireReact_reactServer_development() {
  ...
  "production" !== process.env.NODE_ENV && (function() {
    ...
    react_reactServer_development.version = "19.2.3";
  })();
...
function requireReactDom_reactServer_development() {
  ...
  "production" !== process.env.NODE_ENV && (function() {
    ...
    reactDom_reactServer_development.version = "19.2.3";
  })();
  ...
  function parseModelString(response, obj, key, value, reference, arrayRoot) {
    if ("$" === value[0]) {
      switch (value[1]) {
        ...
        case "K":
          ...
          for (response = response._formData; ; ) {
            ...
            if (value.startsWith(key)) {
              ...
              for (var referencedFormDataKey = value.slice(key.length), i = 0; i < reference.length; i++)
        ...
        case "B":
          return obj = parseInt(value.slice(2), 16), response._formData.data.get(response._prefix + obj);
        case "R":
...
function requireReactServerDomWebpackServer_edge_development() {
  ...
  "production" !== process.env.NODE_ENV && (function() {
    ...
    function getChunk(response, id) {
      var chunks = response._chunks, chunk = chunks.get(id);
      chunk || (chunk = response._formData.data.get(response._prefix + id), chunk = "string" === typeof chunk ? new ReactPromise(
        "resolved_model",
        chunk,
        ...
        switch (value[1]) {
          ...
          case "K":
            ...
            for (response = response._formData; ; ) {
              ...
              null === reference && (reference = value.keys = Array.from(value.data.keys()), value.keyPointer = 0);
      ...
      function resolveToJSON(key, value) {
        ...
        if ("object" === typeof value) {
          ...
          if (value instanceof FormData) {
            ...
            var _data3 = formData;
            key = nextPartId++;
            var prefix2 = formFieldPrefix + "_" + key + "_";
...
const decodeReply = (body, options) => server_edgeExports.decodeReply(body, createServerManifest(), options);
...
function RootLayout({
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("html", { lang: "en", className: "dark", suppressHydrationWarning: true, children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("body", { className: `${inter.variable} antialiased`, children }) });
}
...
const __configHeaders = [{ "source": "/(.*)", "headers": [{ "key": "Cross-Origin-Opener-Policy", "value": "same-origin" }, { "key": "Cross-Origin-Embedder-Policy", "value": "credentialless" }] }];
